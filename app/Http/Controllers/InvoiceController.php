...
class InvoiceController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    try {
      ...
      return response()->json(['status' => 'success', 'message' => '¡Recibo creado!']);
    } catch (\Exception $e) {
  ...
  public function update(Request $request, $id)
  {
    ...
    try {
      ...
      return response()->json(['status' => 'success', 'message' => '¡Recibo actualizado!']);
    } catch (\Exception $e) {
  ...
  public function destroy($id)
  {
    ...
    try {
      ...
      return response()->json(['status' => 'success', 'message' => '¡Recibo eliminado!']);
    } catch (\Exception $e) {
